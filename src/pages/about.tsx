        ...
        <div className="container mx-auto flex px-5 items-center justify-center flex-col">
          <div className="text-center w-full">
            <h2 className="text-4xl sm:text-5xl font-bold p-2 pb-10">
              Perché dovreste scegliere noi come partner?
            </h2>
            <p className="leading-relaxed mb-8 text-lg md:text-xl">
              I clienti dovrebbero scegliere la nostra azienda di sviluppo siti
              web perché offriamo un design accattivante e personalizzato, una
              facile navigazione e una <br />
              solida struttura di sviluppo per garantire un'ottima esperienza
              utente. Inoltre, ci impegniamo a fornire un servizio clienti
              eccellente <br />e un supporto continuo per assicurare che il sito
              web soddisfi le esigenze del cliente in modo efficace.
            </p>
          </div>
        </div>
      </Section>
