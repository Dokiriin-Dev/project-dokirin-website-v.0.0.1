...
import { textColors } from "@/context/colors";
...
export default function AboutPage(
  props: AboutPageProps | (() => AboutPageProps)
): JSX.Element {
  ...
  // const [richText, setRichText] = useState<AboutPageProps>(defaultRichText);
        ...
        <div className="container mx-auto flex px-5 items-center justify-center flex-col">
          <div className="text-center w-full">
            <RichText
              ...
              onChange={(value) => handleRichTextChange(value, "titleCustomer")}
              renderBlock={(props) => (
        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <RichText
              ...
              onChange={(value) => handleRichTextChange(value, "titleMission")}
              renderBlock={(props) => (
                <h3 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">
                  {props.children}
                </h3>
