        ...
        <section className="text-gray-400 body-font bg-cyan-400/50 px-5 md:py-8 py-1 pt-5">
          <div className="container mx-auto flex items-center justify-center flex-col">
            <div className="text-center w-full">
              <h1 className="text-5xl sm:text-6xl font-bold p-2 tracking-tight text-center mb-4 bg-clip-text bg-gradient-to-r border-b dark:border-emerald-300 border-emerald-500 pr-10 pl-10 drop-shadow-xl shadow-gray-400">
                Contatti
              </h1>
              <p className="leading-relaxed mb-8 text-lg md:text-xl">
                Siamo un'azienda di sviluppo web ad alta tecnologia che si
                impegna a fornire prodotti eccellenti in tempo.
                <br />
